...
Beacon_Data Beacon_Map::get_beacon_with_id(int id) const
{
...
std::vector<Beacon_Data> Beacon_Map::get_beacons_with_range(double x, double y, double range) const
{
