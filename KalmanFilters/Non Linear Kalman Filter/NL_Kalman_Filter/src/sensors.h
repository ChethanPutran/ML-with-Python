...
public:
    ...
    std::vector<Lidar_Measurement> generarate_lidar_measurement(double sensor_x, double sensor_y, double sensor_yaw, const Beacon_Map &map);
    void reset();
...
#endif // INCLUDE_NL_KALMAN_SENSORS_H