...
public:
    ...
    Beacon_Data get_beacon_with_id(int id) const;
    std::vector<Beacon_Data> get_beacons_with_range(double x, double y, double range) const;
    std::vector<Beacon_Data> get_beacons() const;
...
#endif // INCLUDE_NL_KALMAN_BEACONS_H